                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" id="code" value="{{generateInvoiceCode()}}" class="form-control code">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="invoice_date" name="date" value="{{date('Y-m-d')}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="invoice_due_date" value="{{date('Y-m-d')}}" name="due_date"
                                       class="form-control">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                            <table class="table table-bordered" id="main_table">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="price[]" id="price" class="form-control price"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group float-right">
                                        ...
                                        <input type="text" name="subtotal" id="subTotal" class="subTotal" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group float-right">
                                        ...
                                        <input type="text" name="discount" id="discount" class="discount"
...
@section('script')
    ...
    <script>
        ...
        // function onDisChange(dis) {
        //     let tr = dis.parents('tr').get();
        //     onQtyChange($(tr).find('.qty'));
        //     onRateChange($(tr).find('.price'));
        // }
